...
const siteData = deserializeFunctions(JSON.parse('{"lang":"ja-JP","dir":"ltr","title":"DQMVI 攻略wiki","description":"Minecraft ドラクエMOD「DQMVI」の攻略情報・モンスター図鑑・アイテムデータまとめ","base":"/dqmvi-wiki/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"siteStats":{"pages":663,"updated":"2026-08-30"},"nav":[{"text":"はじめに","link":"/guide/what-is-dqmvi"},{"text":"遊び方","link":"/play/"},{"text":"データ","items":[{"text":"モンスター図鑑（579体）","link":"/monsters/"},{"text":"魔王・ボス一覧（17体）","link":"/bosses/"},{"text":"出現場所から探す","link":"/biomes/"},{"text":"職業一覧（18種）","link":"/jobs/"},{"text":"呪文一覧（69種）","link":"/spells/"},{"text":"特技一覧（102種）","link":"/skills/"},{"text":"アイテム一覧（1071種）","link":"/items/"}]},{"text":"wikiについて","items":[{"text":"編集のしかた","link":"/guide/edit"},{"text":"ご意見箱","link":"/guide/feedback"}]}],"sidebar":[{"text":"はじめに","collapsed":false,"items":[{"text":"DQMVIとは","link":"/guide/what-is-dqmvi"},{"text":"導入方法","link":"/guide/install"},{"text":"よくある質問","link":"/guide/faq"}]},{"text":"遊び方ガイド","collapsed":false,"items":[{"text":"目次","link":"/play/"},{"text":"はじめに","link":"/play/start"},{"text":"冒険のきほん","link":"/play/basics"},{"text":"ペットと配合","link":"/play/pets"},{"text":"ガンビット","link":"/play/gambit"},{"text":"転職とサブ職業","link":"/play/jobs"},{"text":"アイテム","link":"/play/items"},{"text":"鍛冶","link":"/play/smithing"},{"text":"農業","link":"/play/farming"},{"text":"釣り","link":"/play/fishing"},{"text":"施設と暮らし","link":"/play/facilities"},{"text":"クエスト","link":"/play/quests"}]},{"text":"データ","collapsed":false,"items":[{"text":"モンスター図鑑（579体）","link":"/monsters/"},{"text":"魔王・ボス一覧（17体）","link":"/bosses/"},{"text":"出現場所から探す","link":"/biomes/"},{"text":"職業一覧（18種）","link":"/jobs/"},{"text":"呪文一覧（69種）","link":"/spells/"},{"text":"特技一覧（102種）","link":"/skills/"},{"text":"アイテム一覧（1071種）","link":"/items/"},{"text":"　武器（221種）","link":"/items/weapons"},{"text":"　防具（165種）","link":"/items/armor"},{"text":"　盾（38種）","link":"/items/shields"},{"text":"　アクセサリー（116種）","link":"/items/accessories"},{"text":"　転生装備（56種）","link":"/items/tensei"}]},{"text":"wikiの運営","collapsed":false,"items":[{"text":"編集のしかた","link":"/guide/edit"},{"text":"ご意見箱","link":"/guide/feedback"}]}],"search":{"provider":"local","options":{"miniSearch":{"options":{"tokenize":"_vp-fn_(text) => text.split(/[\\\\s\\\\-_/、。，．,.()（）「」『』【】]+/u).flatMap((w) => {\\n              if (!w) return [];\\n              if (/[ぁ-ヿ一-鿿]/u.test(w)) {\\n                const grams = [];\\n                for (let i = 0; i < w.length; i++) {\\n                  grams.push(w[i]);\\n                  if (i + 2 <= w.length) grams.push(w.slice(i, i + 2));\\n                }\\n                return grams;\\n              }\\n              return [w.toLowerCase()];\\n            })"},"searchOptions":{"combineWith":"AND","fuzzy":false,"prefix":false,"boost":{"title":5,"titles":2,"text":1}}},"translations":{"button":{"buttonText":"検索","buttonAriaLabel":"サイト内検索"},"modal":{"displayDetails":"詳細を表示","resetButtonTitle":"検索をリセット","backButtonTitle":"閉じる","noResultsText":"見つかりませんでした:","footer":{"selectText":"選択","selectKeyAriaLabel":"Enter","navigateText":"移動","navigateUpKeyAriaLabel":"↑","navigateDownKeyAriaLabel":"↓","closeText":"閉じる","closeKeyAriaLabel":"Esc"}}}}},"editLink":{"pattern":"https://github.com/Dhou1magus/dqmvi-wiki/edit/main/docs/:path","text":"このページをブラウザで編集する"},"historyLink":{"pattern":"https://github.com/Dhou1magus/dqmvi-wiki/commits/main/docs/:path","text":"このページの変更履歴・復元"},"lastUpdated":{"text":"最終更新","formatOptions":{"dateStyle":"medium","timeStyle":"short","forceLocale":true}},"outline":{"level":[2,3],"label":"このページの目次"},"docFooter":{"prev":"前のページ","next":"次のページ"},"darkModeSwitchLabel":"テーマ","lightModeSwitchTitle":"ライトモードに切り替え","darkModeSwitchTitle":"ダークモードに切り替え","sidebarMenuLabel":"メニュー","returnToTopLabel":"トップへ戻る","externalLinkIcon":true,"socialLinks":[{"icon":"github","link":"https://github.com/Dhou1magus/dqmvi-wiki"}],"footer":{"message":"有志による非公式wikiです。記載内容の正確性は保証されません。 <a href=\\"/dqmvi-wiki/guide/feedback\\">ご意見箱</a>","copyright":"DQMVI 攻略wiki"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.Bo95frRy.js"));
...
function isNumericColumn(rows, index) {
  ...
  for (const row of rows) {
    const text = (_b = (_a = row.cells[index]) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
...
function sortRows(tbody, headers, index, direction, numeric) {
  const sign = direction === "asc" ? 1 : -1;
  const rows = [...tbody.rows];
  rows.sort((a, b) => {
    var _a, _b, _c, _d;
    const ta = ((_b = (_a = a.cells[index]) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim()) ?? "";
    const tb = ((_d = (_c = b.cells[index]) == null ? void 0 : _c.textContent) == null ? void 0 : _d.trim()) ?? "";
    if (numeric) {
...
function markNoWrapColumns(table) {
  var _a, _b, _c;
  const rows = [...((_a = table.tBodies[0]) == null ? void 0 : _a.rows) ?? []];
  const headers = [...((_c = (_b = table.tHead) == null ? void 0 : _b.rows[0]) == null ? void 0 : _c.cells) ?? []];
  if (!rows.length || !headers.length) return;
  headers.forEach((th, i) => {
    var _a2, _b2, _c2, _d;
    let longest = ((_a2 = th.textContent) == null ? void 0 : _a2.trim().length) ?? 0;
    for (const row of rows) {
      const text = ((_c2 = (_b2 = row.cells[i]) == null ? void 0 : _b2.textContent) == null ? void 0 : _c2.trim()) ?? "";
      if (text.length > longest) longest = text.length;
      if (longest > NOWRAP_MAX_LENGTH) return;
    }
    th.classList.add("nowrap");
    for (const row of rows) (_d = row.cells[i]) == null ? void 0 : _d.classList.add("nowrap");
  });
}
function setupSortableTables() {
  var _a, _b, _c;
  const tables = document.querySelectorAll(".Layout.wide-page .vp-doc table");
  for (const table of tables) {
    if (table.dataset.tableReady === "yes") continue;
    table.dataset.tableReady = "yes";
    const tbody = table.tBodies[0];
    const headers = [...((_b = (_a = table.tHead) == null ? void 0 : _a.rows[0]) == null ? void 0 : _b.cells) ?? []];
    ...
    if (!optedIn && ((_c = headers[0].textContent) == null ? void 0 : _c.trim()) !== SORTABLE_FIRST_HEADER) continue;
    ...
    headers.forEach((th, i) => {
      var _a2;
      const label = ((_a2 = th.textContent) == null ? void 0 : _a2.trim()) ?? "";
      th.tabIndex = 0;
      ...
      const toggle = () => {
        ...
        const firstPress = i === 0 || !numericColumn[i] ? "asc" : "desc";
        const direction = current === "ascending" ? "desc" : current === "descending" ? "asc" : firstPress;
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        role: "group",
        "aria-label": "配色テーマ"
      }, _attrs))}><button type="button" class="${ssrRenderClass({ on: mode.value === "light" })}"${ssrRenderAttr("aria-pressed", mode.value === "light")} title="ライトモード" aria-label="ライトモード"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="4.2"></circle><path d="M12 2.5v2M12 19.5v2M2.5 12h2M19.5 12h2M5.2 5.2l1.4 1.4M17.4 17.4l1.4 1.4M18.8 5.2l-1.4 1.4M6.6 17.4l-1.4 1.4"></path></svg></button><button type="button" class="${ssrRenderClass({ on: mode.value === "auto" })}"${ssrRenderAttr("aria-pressed", mode.value === "auto")} title="端末の設定に合わせる" aria-label="端末の設定に合わせる"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="4.5" width="18" height="12.5" rx="1.8"></rect><path d="M9 20.5h6"></path></svg></button><button type="button" class="${ssrRenderClass({ on: mode.value === "dark" })}"${ssrRenderAttr("aria-pressed", mode.value === "dark")} title="ダークモード" aria-label="ダークモード"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 14.2A8.2 8.2 0 1 1 9.8 4a6.6 6.6 0 0 0 10.2 10.2z"></path></svg></button></div>`);
    };
  }
};
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/ThemeSwitch.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const editUrl = computed(
      () => {
        var _a;
        return (((_a = theme2.value.editLink) == null ? void 0 : _a.pattern) || "").replace(/:path/g, page.value.filePath);
      }
    );
    const historyUrl = computed(
      () => {
        var _a;
        return (((_a = theme2.value.historyLink) == null ? void 0 : _a.pattern) || "").replace(/:path/g, page.value.filePath);
      }
    );
    return (_ctx, _push, _parent, _attrs) => {
      if (show.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-actions" }, _attrs))}><a${ssrRenderAttr("href", editUrl.value)} target="_blank" rel="noreferrer"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 20h4L19 9a2.1 2.1 0 0 0-3-3L5 17v3z"></path><path d="M14.5 6.5l3 3"></path></svg> このページをブラウザで編集する </a><a${ssrRenderAttr("href", historyUrl.value)} target="_blank" rel="noreferrer"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.5 12a8.5 8.5 0 1 0 2.6-6.1"></path><path d="M3.2 4.6v4.2h4.2"></path><path d="M12 7.6V12l3 1.8"></path></svg> このページの変更履歴・復元 </a></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/PageActions.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const FEEDBACK_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSd8Yf_N0-IGD7ABsbOOHrO6YTvKqkhCickYqA-ZoqDTWKS-eA/viewform?embedded=true";
const FEEDBACK_COOLDOWN_MINUTES = 10;
const FEEDBACK_FORM_HEIGHT = 1200;
const FEEDBACK_FORM_HEIGHT_NARROW = 1320;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const COOLDOWN_MS = Math.max(1, FEEDBACK_COOLDOWN_MINUTES) * 60 * 1e3;
    ...
    function startTimer() {
      stopTimer();
      tick();
      timer = window.setInterval(tick, 1e3);
    }
    const remainText = computed(() => {
      const sec = Math.ceil(remain.value / 1e3);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (show.value) {
        _push(`<section${ssrRenderAttrs(mergeProps({ class: "feedback" }, _attrs))} data-v-7ddffabb>`);
        if (!formUrl.value) {
          _push(`<div class="fb-panel" data-v-7ddffabb><p class="fb-title" data-v-7ddffabb>ただいま準備中です</p><p data-v-7ddffabb>投稿の受け付けをまもなく開始します。もう少しお待ちください。</p></div>`);
        } else if (state.value === "thanks") {
          _push(`<div class="fb-panel fb-thanks" data-v-7ddffabb><p class="fb-title" data-v-7ddffabb>送信しました。ありがとうございます</p><p data-v-7ddffabb>いただいた内容は運営者が確認します。返事はできませんが、すべて読みます。</p><p class="fb-note" data-v-7ddffabb>続けて送るのを防ぐため、次の投稿は ${ssrInterpolate(remainText.value)} からできます。</p></div>`);
        } else if (state.value === "cooldown") {
          _push(`<div class="fb-panel" data-v-7ddffabb><p class="fb-title" data-v-7ddffabb>少し時間をおいてください</p><p data-v-7ddffabb>さきほど投稿を受け取りました。次の投稿は ${ssrInterpolate(remainText.value)} からできます。</p><p class="fb-note" data-v-7ddffabb>書き足したいことがあるときは、時間をおいてまとめて送ってください。</p></div>`);
        } else {
          _push(`<div class="fb-frame" style="${ssrRenderStyle(frameStyle)}" data-v-7ddffabb>`);
          if (mounted.value) {
            _push(`<iframe${ssrRenderAttr("src", formUrl.value)} title="ご意見の投稿フォーム" loading="lazy" referrerpolicy="no-referrer" sandbox="allow-forms allow-scripts allow-same-origin allow-popups" data-v-7ddffabb></iframe>`);
          } else {
            _push(`<div class="fb-skeleton" data-v-7ddffabb>フォームを読み込んでいます…</div>`);
          }
          _push(`</div>`);
        }
        if (formUrl.value) {
          _push(`<p class="fb-foot" data-v-7ddffabb> 投稿はGoogleフォームで受け付けています。名前や連絡先を書かなければ、誰が送ったかは分かりません。 </p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/FeedbackBox.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const FeedbackBox = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7ddffabb"]]);
const _sfc_main = {
  __name: "TopPage",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const meta = [
      ...
      { label: "最終更新", value: ((_a = theme2.value.siteStats) == null ? void 0 : _a.updated) ?? "—" },
      { label: "ページ数", value: String(((_b = theme2.value.siteStats) == null ? void 0 : _b.pages) ?? "—") },
      { label: "編集者", value: "募集中" }
    ];
    const start = [
    ...
    const cats = [
      ...
      },
      {
        ...
        items: [
          ...
          { t: "盾 38種", link: "/items/shields" },
          { t: "アクセサリー 116種", link: "/items/accessories" },
      ...
      },
      {
        ...
        items: [
          ...
          { t: "素材 132種", link: "/items/" },
          { t: "種・作物", link: "/play/farming" },
          { t: "ちいさなメダル" },
          { t: "入手場所逆引き" }
        ]
      },
      ...
      },
      {
        ...
        items: [
          ...
          { t: "ネザー", link: "/biomes/nether" },
          { t: "果ての世界", link: "/biomes/end" },
          { t: "バイオーム一覧", link: "/biomes/" },
          { t: "座標メモ" }
        ]
      },
      {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(frontmatter).top) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "wiki-top" }, _attrs))}><div class="top-head"><h1>${ssrInterpolate(unref(frontmatter).title)}</h1><p class="sub">${ssrInterpolate(unref(frontmatter).tagline)}</p></div><div class="top-meta"><!--[-->`);
        ssrRenderList(meta, (m) => {
          _push(`<span><b>${ssrInterpolate(m.label)}</b>${ssrInterpolate(m.value)}</span>`);
        });
        _push(`<!--]--></div><div class="startbar"><!--[-->`);
        ssrRenderList(start, (s) => {
          _push(`<a${ssrRenderAttr("href", unref(withBase)(s.link))}><span class="n">${ssrInterpolate(s.n)}</span><span class="t">${ssrInterpolate(s.t)}</span><span class="d">${ssrInterpolate(s.d)}</span></a>`);
        });
        _push(`<!--]--></div><h2 class="sec-h">大題目<span class="note">灰色の項目はまだ作られていないページです</span></h2><div class="cat-wall"><!--[-->`);
        ssrRenderList(cats, (c) => {
          _push(`<div class="${ssrRenderClass([{ acc: c.acc }, "cat"])}"><h3>${ssrInterpolate(c.title)}</h3><ul><!--[-->`);
          ssrRenderList(c.items, (i) => {
            _push(`<li class="${ssrRenderClass({ wide: i.wide })}">`);
            if (i.link) {
              _push(`<a${ssrRenderAttr("href", unref(withBase)(i.link))}>${ssrInterpolate(i.t)}</a>`);
            } else {
              _push(`<span class="todo">${ssrInterpolate(i.t)}</span>`);
            }
            _push(`</li>`);
          });
          _push(`<!--]--></ul></div>`);
        });
        _push(`<!--]--></div><div class="two-col"><div><h2 class="sec-h">更新履歴</h2><div class="log"><ul><!--[-->`);
        ssrRenderList(log, (l) => {
          _push(`<li><time>${ssrInterpolate(l.d)}</time><a${ssrRenderAttr("href", unref(withBase)(l.link))}>${ssrInterpolate(l.t)}</a><span class="who">${ssrInterpolate(l.who)}</span></li>`);
        });
        _push(`<!--]--></ul></div></div><div><h2 class="sec-h">編集募集中</h2><div class="wanted"><ul><!--[-->`);
        ssrRenderList(wanted, (w) => {
          _push(`<li>${ssrInterpolate(w)}</li>`);
        });
        _push(`<!--]--></ul><p> 手が足りていない項目です。断片的な情報でも構いません。書き方は <a${ssrRenderAttr("href", unref(withBase)("/guide/edit"))}>編集のしかた</a>を見てください。 </p></div></div></div><div class="about"><b>このwikiについて</b>　有志による非公式wikiです。掲載内容の正確性は保証されません。数値は検証環境によって異なる場合があります。誤りを見つけたら、そのページの「このページをブラウザで編集する」から直してください。編集履歴はすべて残るので、失敗しても元に戻せます。 </div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/TopPage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RawTheme = {
  extends: theme,
