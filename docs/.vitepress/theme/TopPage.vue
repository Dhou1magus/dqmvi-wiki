...
const log = [
  { d: '09-24', t: 'モンスター図鑑を DQMVI 0.31.97 に合わせて更新（40体を追加し、ランク5・6の23体のデータを掲載）', link: '/monsters/', who: 'よっしー' },
  { d: '09-24', t: 'ドロップ品を 0.31.97 に合わせて更新し、転生装備11種のページとアクセサリーの特殊効果を追加', link: '/drops/', who: 'よっしー' },
  { d: '09-24', t: '転生装備一覧に30種を追加して71種に（防具・アクセサリー一覧にも掲載）', link: '/items/tensei', who: 'よっしー' },
  { d: '09-24', t: '神獣王の戦篭手のガードの値を修正', link: '/items/weapons#gauntlet', who: 'よっしー' },
  { d: '09-24', t: '武器一覧を DQMVI 0.31.97 に合わせて更新（大鎌・戦籠手・ドリル・鎖鎌とダンジョン限定の武器を追加し、銃・戦輪・竪琴の数値を掲載）', link: '/items/weapons', who: 'よっしー' },
  { d: '09-24', t: '転生装備とドロップ品ページの武器の特殊効果の空欄を埋めた', link: '/items/tensei', who: 'よっしー' },
  { d: '09-24', t: '本文の {…} 指定で使えるものを id と class だけに整理', link: '/guide/edit', who: 'よっしー' },
  { d: '09-24', t: '職業一覧を DQMVI 0.31.97 に合わせて更新し、評価と数値をタブで切り替えられるように', link: '/jobs/', who: 'よっしー' },
  { d: '09-24', t: '各職業のページを 0.31.97 に合わせて更新（ドリル・鎖鎌の適性、スキルのセット、構えられる盾）', link: '/jobs/senshi', who: 'よっしー' },
  { d: '09-24', t: '表の並べ替えで評価が SSS→E の順に並ぶように修正', link: '/jobs/', who: 'よっしー' },
  { d: '09-17', t: 'ダンジョン一覧に67件の名前を掲載', link: '/play/dungeons', who: 'よっしー' },
  { d: '09-17', t: 'モンスター図鑑を DQMVI 0.29.67 に合わせて更新（59体を追加、図鑑No.と前後移動を修正）', link: '/monsters/', who: 'よっしー' },
  { d: '09-17', t: 'ドロップ品の「落とすモンスター」を更新し、転生装備4種のページを追加', link: '/drops/', who: 'よっしー' },
