---
title: アイテム一覧
description: DQMVIに出てくるアイテム1418種。武器・防具・盾・アクセサリー・転生装備は種類ごとのページに分けています。
pageClass: wide-page sortable-list
---

# アイテム一覧

DQMVIに出てくるアイテムは **1418種** です。
...
| 種類 | 数 | 中身 |
| --- | ---: | --- |
| [武器](/items/weapons) | 576 | 剣・槍・棍・爪・斧・弓など。 |
| [防具](/items/armor) | 166 | 兜・鎧・小手・服など、身につける装備。 |
| [盾](/items/shields) | 38 | 片手にかまえる盾。なべのふたやトレイもここに入ります。 |
| [アクセサリー](/items/accessories) | 130 | 指輪・ピアス・首飾り・腕輪など、効果を足す小物。 |
| [転生装備](/items/tensei) | 41 | 転生したモンスターから手に入る装備。 |
